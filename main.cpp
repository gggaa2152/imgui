...
static FrostTheme g_themes[4] = {
    { ImVec4(0.00f, 0.94f, 1.00f, 1.f), ImVec4(0.00f, 0.68f, 0.82f, 1.f), ImVec4(1.00f, 0.17f, 0.84f, 0.55f), ImVec4(0.00f, 0.94f, 1.00f, 0.22f), ImVec4(1.00f, 0.17f, 0.84f, 0.18f), (const char*)u8"霓虹" },
    { ImVec4(0.72f, 0.25f, 1.00f, 1.f), ImVec4(0.55f, 0.14f, 0.88f, 1.f), ImVec4(0.00f, 0.94f, 1.00f, 0.55f), ImVec4(0.72f, 0.25f, 1.00f, 0.22f), ImVec4(0.00f, 0.94f, 1.00f, 0.18f), (const char*)u8"电紫" },
    { ImVec4(1.00f, 0.15f, 0.45f, 1.f), ImVec4(0.82f, 0.06f, 0.32f, 1.f), ImVec4(0.00f, 0.94f, 1.00f, 0.55f), ImVec4(1.00f, 0.15f, 0.45f, 0.22f), ImVec4(0.00f, 0.94f, 1.00f, 0.18f), (const char*)u8"血樱" },
    { ImVec4(0.00f, 1.00f, 0.53f, 1.f), ImVec4(0.00f, 0.80f, 0.42f, 1.f), ImVec4(1.00f, 0.17f, 0.84f, 0.55f), ImVec4(0.00f, 1.00f, 0.53f, 0.22f), ImVec4(0.00f, 0.94f, 1.00f, 0.18f), (const char*)u8"矩阵" },
};
...
void ApplyFrostedTheme() {
    ...
    // ---- 赛博朋克：锐利切角 + 霓虹描边 ----
    s.WindowRounding = 3.0f * sc;
    s.ChildRounding = 2.0f * sc;
    s.FrameRounding = 2.0f * sc;
    s.PopupRounding = 3.0f * sc;
    s.ScrollbarRounding = 3.0f * sc;
    s.GrabRounding = 2.0f * sc;
    s.TabRounding = 2.0f * sc;
    ...
    s.ScrollbarSize = 24.0f * sc;
    s.GrabMinSize = 20.0f * sc;
    s.Colors[ImGuiCol_Text] = ImVec4(0.88f, 0.97f, 1.00f, 1.0f);
    s.Colors[ImGuiCol_TextDisabled] = ImVec4(0.42f, 0.55f, 0.62f, 1.0f);
    s.Colors[ImGuiCol_WindowBg] = ImVec4(0.012f, 0.02f, 0.045f, 0.92f);
    s.Colors[ImGuiCol_ChildBg] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.035f);
    s.Colors[ImGuiCol_PopupBg] = ImVec4(0.02f, 0.03f, 0.06f, 0.97f);
    s.Colors[ImGuiCol_Border] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.42f);
    s.Colors[ImGuiCol_BorderShadow] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.10f);
    s.Colors[ImGuiCol_FrameBg] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.06f);
    s.Colors[ImGuiCol_FrameBgHovered] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.14f);
    s.Colors[ImGuiCol_FrameBgActive] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.22f);
    s.Colors[ImGuiCol_TitleBg] = ImVec4(0.02f, 0.03f, 0.06f, 0.95f);
    s.Colors[ImGuiCol_TitleBgActive] = ImVec4(t.primary.x * 0.30f, t.primary.y * 0.30f, t.primary.z * 0.30f, 0.95f);
    s.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.02f, 0.03f, 0.06f, 0.85f);
    s.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.02f, 0.03f, 0.06f, 0.90f);
    s.Colors[ImGuiCol_ScrollbarBg] = ImVec4(0.01f, 0.02f, 0.04f, 0.60f);
    s.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.28f);
    s.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.48f);
    ...
    s.Colors[ImGuiCol_Button] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.20f);
    s.Colors[ImGuiCol_ButtonHovered] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.42f);
    s.Colors[ImGuiCol_ButtonActive] = ImVec4(t.primaryHover.x, t.primaryHover.y, t.primaryHover.z, 0.75f);
    s.Colors[ImGuiCol_Header] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.24f);
    s.Colors[ImGuiCol_HeaderHovered] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.40f);
    s.Colors[ImGuiCol_HeaderActive] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.58f);
    s.Colors[ImGuiCol_Separator] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.18f);
    s.Colors[ImGuiCol_SeparatorHovered] = ImVec4(t.accentGlow.x, t.accentGlow.y, t.accentGlow.z, 0.65f);
    s.Colors[ImGuiCol_SeparatorActive] = t.accentGlow;
    s.Colors[ImGuiCol_ResizeGrip] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.20f);
    s.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.45f);
    s.Colors[ImGuiCol_ResizeGripActive] = t.primary;
    s.Colors[ImGuiCol_Tab] = ImVec4(0.02f, 0.03f, 0.06f, 0.85f);
    s.Colors[ImGuiCol_TabHovered] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.45f);
    s.Colors[ImGuiCol_TabSelected] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.30f);
    s.Colors[ImGuiCol_TabSelectedOverline] = t.primary;
    s.Colors[ImGuiCol_TabDimmed] = ImVec4(0.02f, 0.03f, 0.06f, 0.60f);
    s.Colors[ImGuiCol_TabDimmedSelected] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.16f);
    s.Colors[ImGuiCol_PlotLines] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.80f);
    s.Colors[ImGuiCol_PlotHistogram] = t.primary;
    s.Colors[ImGuiCol_TextSelectedBg] = ImVec4(t.accentGlow.x, t.accentGlow.y, t.accentGlow.z, 0.35f);
    s.Colors[ImGuiCol_NavCursor] = ImVec4(t.primary.x, t.primary.y, t.primary.z, 0.85f);
}
...
void DrawFrostedPanel(ImDrawList* dl, ImVec2 mn, ImVec2 mx, float alpha, float rounding) {
    ...
    float sc = g_autoScale;
    // 半透明深色底 + 顶部霓虹渐变
    dl->AddRectFilled(mn, mx, IM_COL32(4, 7, 14, (int)(238 * alpha)), rounding);
    dl->AddRectFilledMultiColor(mn, mx,
        ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.10f * alpha)),
        ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.07f * alpha)),
        IM_COL32(0, 0, 0, 0), IM_COL32(0, 0, 0, 0));
    // 霓虹描边
    dl->AddRect(mn, mx, ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.55f * alpha)), rounding, 0, 1.6f);
    // 四角霓虹角标（切角装饰）
    float c = 12.0f * sc;
    float thk = 2.2f * sc;
    ImU32 cy = ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.95f * alpha));
    ImU32 mg = ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.85f * alpha));
    dl->AddLine(ImVec2(mn.x, mn.y + c), ImVec2(mn.x, mn.y), cy, thk);
    dl->AddLine(ImVec2(mn.x, mn.y), ImVec2(mn.x + c, mn.y), cy, thk);
    dl->AddLine(ImVec2(mx.x - c, mn.y), ImVec2(mx.x, mn.y), mg, thk);
    dl->AddLine(ImVec2(mx.x, mn.y), ImVec2(mx.x, mn.y + c), mg, thk);
    dl->AddLine(ImVec2(mn.x, mx.y - c), ImVec2(mn.x, mx.y), mg, thk);
    dl->AddLine(ImVec2(mn.x, mx.y), ImVec2(mn.x + c, mx.y), mg, thk);
    dl->AddLine(ImVec2(mx.x - c, mx.y), ImVec2(mx.x, mx.y), cy, thk);
    dl->AddLine(ImVec2(mx.x, mx.y), ImVec2(mx.x, mx.y - c), cy, thk);
    // 缓慢下移的扫描线
    float hgt = mx.y - mn.y;
    if (hgt > 4.0f) {
        float sy = mn.y + fmodf((float)ImGui::GetTime() * 46.0f, hgt);
        dl->AddRectFilled(ImVec2(mn.x + 2.0f, sy), ImVec2(mx.x - 2.0f, sy + 1.4f * sc),
            ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.10f * alpha)));
    }
}
...
void DrawGlassSeparator() {
    ...
    // 渐变霓虹横线（左亮右隐）
    dl->AddRectFilledMultiColor(p, ImVec2(p.x + w, p.y + 1.2f * sc),
        ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.75f)),
        ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.05f)),
        IM_COL32(0, 0, 0, 0), IM_COL32(0, 0, 0, 0));
    // 中段品红菱形节点
    float cx = p.x + w * 0.5f, cy = p.y + 0.6f * sc;
    ImVec2 d[4] = {
        ImVec2(cx, cy - 3.0f * sc), ImVec2(cx + 3.0f * sc, cy),
        ImVec2(cx, cy + 3.0f * sc), ImVec2(cx - 3.0f * sc, cy)
    };
    dl->AddConvexPolyFilled(d, 4, ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.95f)));
...
void DrawSectionTitle(const char* title) {
    ...
    // 左侧双霓虹竖条
    dl->AddRectFilled(ImVec2(p.x, p.y + 1.0f), ImVec2(p.x + 3.0f * sc, p.y + fs), ImGui::GetColorU32(th.primary));
    dl->AddRectFilled(ImVec2(p.x + 5.0f * sc, p.y + 1.0f), ImVec2(p.x + 7.0f * sc, p.y + fs), ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.95f)));
    // 标题底光带
    dl->AddRectFilledMultiColor(ImVec2(p.x + 9.0f * sc, p.y), ImVec2(p.x + 9.0f * sc + tSz.x + 14.0f * sc, p.y + fs + 4.0f * sc),
        ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.20f)),
        ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.02f)),
        ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.02f)),
        ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.20f)));
    ImGui::SetCursorScreenPos(ImVec2(p.x + 11.0f * sc, p.y));
    ImGui::TextColored(ImVec4(th.primary.x * 0.72f + 0.28f, th.primary.y * 0.72f + 0.28f, th.primary.z * 0.72f + 0.28f, 1.0f), "%s", title);
    DrawGlassSeparator();
}
...
bool ThemePill(const char* name, bool active, int idx) {
    ...
    if (ImGui::ItemAdd(bb, id)) {
        ...
        // 切角多边形
        ImVec2 pts[5] = {
            ImVec2(bb.Min.x + cut, bb.Min.y), ImVec2(bb.Max.x, bb.Min.y),
            ImVec2(bb.Max.x, bb.Max.y - cut), ImVec2(bb.Max.x - cut, bb.Max.y),
            ImVec2(bb.Min.x, bb.Max.y)
        };
        ImU32 bg = active ? ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.80f))
                          : ImGui::GetColorU32(ImLerp(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.05f),
                                                      ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.24f), anim));
        win->DrawList->AddConvexPolyFilled(pts, 5, bg);
        ImU32 bd = active ? ImGui::GetColorU32(ImVec4(1.0f, 1.0f, 1.0f, 0.85f))
                          : ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.30f + 0.45f * anim));
        win->DrawList->AddPolyline(pts, 5, bd, ImDrawFlags_Closed, 1.2f * sc);
        if (active) win->DrawList->AddCircleFilled(ImVec2(bb.Max.x - 7.0f * sc, bb.Min.y + 7.0f * sc), 2.2f * sc, IM_COL32(255, 255, 255, 230), 12);
        win->DrawList->AddText(ImVec2(bb.Min.x + pad.x, bb.Min.y + pad.y), active ? IM_COL32(6, 10, 18, 255) : IM_COL32(170, 215, 230, 255), name);
    }
    return pressed;
}
...
void DrawThemeBar() {
    ...
    DrawFrostedPanel(dl, mn, mx, 0.92f, 3.0f * g_autoScale);
    ...
    ImGui::TextColored(ImVec4(UITheme().primary.x * 0.72f + 0.28f, UITheme().primary.y * 0.72f + 0.28f, UITheme().primary.z * 0.72f + 0.28f, 1.f), (const char*)u8"主题 // THEME");
    ImGui::SameLine();
...
void DrawStatusHeader() {
    ...
    ImVec2 mx(mn.x + w, mn.y + h);
    DrawFrostedPanel(dl, mn, mx, 1.0f, 3.0f * g_autoScale);
    float sc = g_autoScale * g_scale;
    float t = (float)ImGui::GetTime();
    float pulse = 0.5f + 0.5f * sinf(t * 4.0f);
    // 脉冲信号灯
    ImVec2 dotPos(mn.x + 22.0f * sc, mn.y + h * 0.5f);
    dl->AddCircleFilled(dotPos, 9.0f * sc + 2.5f * sc * pulse, ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.15f + 0.15f * pulse)), 24);
    dl->AddCircle(dotPos, 6.0f * sc, ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.95f)), 20, 1.6f * sc);
    dl->AddCircleFilled(dotPos, 3.0f * sc, ImGui::GetColorU32(th.primary), 16);
    dl->AddText(ImGui::GetFont(), ImGui::GetFontSize() * 1.05f, ImVec2(mn.x + 36.0f * sc, mn.y + (h - ImGui::GetFontSize() * 1.05f) * 0.5f),
        IM_COL32(232, 250, 255, 255), (const char*)u8"金铲铲助手 // CYBER");
    ...
    ImU32 badgeBg = online ? IM_COL32(0, 240, 255, 26) : IM_COL32(255, 43, 110, 26);
    ImU32 badgeBorder = online ? IM_COL32(0, 240, 255, 140) : IM_COL32(255, 43, 110, 140);
    ImU32 badgeText = online ? IM_COL32(140, 250, 255, 255) : IM_COL32(255, 150, 190, 255);
    dl->AddRectFilled(bMin, bMax, badgeBg, 2.0f * sc);
    dl->AddRect(bMin, bMax, badgeBorder, 2.0f * sc, 0, 1.2f * sc);
    dl->AddRectFilled(bMin, ImVec2(bMin.x + 3.0f * sc, bMax.y), badgeText, 2.0f * sc);
    dl->AddText(ImVec2(bMin.x + 10.0f * sc, bMin.y + (26.0f * sc - stSz.y) * 0.5f), badgeText, stTxt);

    // 2. 实时全量真实帧率徽章 (高刷霓虹青 / 标准翠绿 / 低帧暖黄)
    char fpsBuf[48];
    ...
    ImU32 fpsBg = (g_realtime_fps >= 115.0f) ? IM_COL32(0, 240, 255, 28) :
                  (g_realtime_fps >= 55.0f)  ? IM_COL32(0, 255, 136, 26) :
                                              IM_COL32(255, 176, 0, 26);
    ImU32 fpsBorder = (g_realtime_fps >= 115.0f) ? IM_COL32(0, 240, 255, 150) :
                      (g_realtime_fps >= 55.0f)  ? IM_COL32(0, 255, 136, 130) :
                                                  IM_COL32(255, 176, 0, 130);
    ImU32 fpsText = (g_realtime_fps >= 115.0f) ? IM_COL32(150, 250, 255, 255) :
                    (g_realtime_fps >= 55.0f)  ? IM_COL32(140, 255, 190, 255) :
                                                IM_COL32(255, 214, 120, 255);
    dl->AddRectFilled(fpsMin, fpsMax, fpsBg, 2.0f * sc);
    dl->AddRect(fpsMin, fpsMax, fpsBorder, 2.0f * sc, 0, 1.2f * sc);
    dl->AddRectFilled(fpsMin, ImVec2(fpsMin.x + 3.0f * sc, fpsMax.y), fpsText, 2.0f * sc);
...
void DrawMenuOrb() {
    ...
    // 外圈霓虹脉冲
    fg->AddCircleFilled(center, r + 7.0f + 3.0f * pulse, ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.10f + 0.10f * pulse)), 48);
    fg->AddCircleFilled(center, r + 2.0f, ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.22f)), 48);
    fg->AddCircleFilled(center, r, IM_COL32(6, 10, 18, 235), 48);
    // 旋转霓虹刻度环（12 段）
    for (int i = 0; i < 12; i++) {
        float a0 = t * 1.6f + (float)i * 0.5236f;
        fg->PathArcTo(center, r - 2.0f, a0, a0 + 0.22f, 6);
        fg->PathStroke(ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.9f)), 0, 2.0f);
    }
    fg->AddCircle(center, r, ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.75f)), 48, 1.6f);
    // 核心
    fg->AddCircleFilled(center, r * 0.34f, ImGui::GetColorU32(th.primary), 24);
    fg->AddCircleFilled(center, r * 0.16f, IM_COL32(255, 255, 255, 235), 16);
...
bool FrostSidebarBtn(const char* label, bool selected, int id) {
    ...
    if (ImGui::ItemAdd(bb, btnId)) {
        ...
        FrostTheme& th = UITheme();
        // 赛博底：选中为霓虹填充，悬停渐亮
        ImU32 bg = selected ? ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.30f))
                            : ImGui::GetColorU32(ImLerp(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.03f),
                                                        ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.14f), anim));
        win->DrawList->AddRectFilled(bb.Min, bb.Max, bg, 2.0f * sc);
        // 左侧霓虹指示条
        if (selected || anim > 0.02f) {
            float bw = 3.0f * sc * (selected ? 1.0f : anim);
            ImU32 barCol = selected ? ImGui::GetColorU32(th.primary)
                                    : ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.6f * anim));
            win->DrawList->AddRectFilled(ImVec2(bb.Min.x, bb.Min.y + 2.0f), ImVec2(bb.Min.x + bw, bb.Max.y - 2.0f), barCol, 1.0f);
        }
        // 边框
        if (selected) {
            win->DrawList->AddRect(bb.Min, bb.Max, ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.85f)), 2.0f * sc, 0, 1.4f);
            win->DrawList->AddRect(ImVec2(bb.Min.x - 1.0f, bb.Min.y - 1.0f), ImVec2(bb.Max.x + 1.0f, bb.Max.y + 1.0f), ImGui::GetColorU32(th.accentGlow), 3.0f * sc, 0, 1.0f);
        } else if (hovered) {
            win->DrawList->AddRect(bb.Min, bb.Max, ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.35f)), 2.0f * sc, 0, 1.0f);
        }
        float pad = 10.0f * sc;
        ImU32 iconCol = selected ? IM_COL32(255, 255, 255, 255) : IM_COL32(150, 200, 215, 255);
        ...
        win->DrawList->AddText(ImVec2(bb.Min.x + pad + 22.0f * sc, bb.Min.y + (size.y - ImGui::GetFontSize()) * 0.5f),
            selected ? IM_COL32(255, 255, 255, 255) : IM_COL32(170, 205, 220, 255), label);
    }
    return pressed;
}
...
// 0xaf4fe0c —— 真正的小小英雄换肤方法: x0=模型路径, x1=展示模型名 —— 替换入口
//   x0 例: "art_tft_raw/little_legend_res/model/t_qieqishispring/t_qieqishispring_horse/low"
//   x1 例: "t_qieqishispring_horse_1_show"
static uintptr_t g_ll_load_offset = 0xaf4fe0c;
...
static void* HK_LoadLittleLegend(void* x0, void* x1, void* x2, void* x3, void* x4, void* x5) {
    ...
    if (g_ll_auto_enabled && g_ll_selected >= 0 && g_ll_selected < (int)g_ll_skins.size()
        ...
        if (cur1.find('/') != std::string::npos) {
            ...
            if (nb && na) return g_orig_LoadLittleLegend(nb, na, x2, x3, x4, x5);
        }
    }
    return g_orig_LoadLittleLegend(x0, x1, x2, x3, x4, x5);
}
...
static void InstallLLHook() {
    ...
    void* paf = (void*)(g_il2cppTrueBase + g_ll_load_offset);
    if (IsValidExecutableAddr(paf)) {
        if (SafeDobbyHook(paf, (void*)HK_LoadLittleLegend, (void**)&g_orig_LoadLittleLegend) == 0) {
            g_ll_hook_installed = true;
            LOGI("[LL] Hooked 0xaf4fe0c @ %p", paf);
            AddActionLog((const char*)u8"-> [小小英雄] 已挂载 0xaf4fe0c (换肤入口)");
...
bool ModernToggle(const char* label, bool* v, int idx) {
    ...
    FrostTheme& th = UITheme();
    float sc = g_autoScale;
    ImVec4 offCol(0.10f, 0.12f, 0.18f, 0.95f);
    ImVec4 onCol(th.primary.x, th.primary.y, th.primary.z, 0.95f);
    // 切角轨道
    float cut = 3.0f * sc;
    ImVec2 tp[5] = {
        ImVec2(bb.Min.x + cut, bb.Min.y), ImVec2(bb.Min.x + w, bb.Min.y),
        ImVec2(bb.Min.x + w, bb.Min.y + h - cut), ImVec2(bb.Min.x + w - cut, bb.Min.y + h),
        ImVec2(bb.Min.x, bb.Min.y + h)
    };
    win->DrawList->AddConvexPolyFilled(tp, 5, ImGui::GetColorU32(ImLerp(offCol, onCol, g_anim[idx])));
    ImU32 trackBorder = g_anim[idx] > 0.5f ? ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 1.0f)) : IM_COL32(255, 255, 255, 45);
    win->DrawList->AddPolyline(tp, 5, trackBorder, ImDrawFlags_Closed, 1.2f * sc);
    // 方形霓虹滑块
    ImVec2 hc = bb.Min + ImVec2(h*0.5f + g_anim[idx]*(w-h), h*0.5f);
    float ks = h * 0.5f - 3.5f;
    win->DrawList->AddRectFilled(ImVec2(hc.x - ks, hc.y - ks), ImVec2(hc.x + ks, hc.y + ks), *v ? IM_COL32(8, 14, 22, 255) : IM_COL32(190, 200, 210, 255), 1.5f);
    if (*v) win->DrawList->AddRect(ImVec2(hc.x - ks - 1.0f, hc.y - ks - 1.0f), ImVec2(hc.x + ks + 1.0f, hc.y + ks + 1.0f), ImGui::GetColorU32(ImVec4(th.accentGlow.x, th.accentGlow.y, th.accentGlow.z, 0.9f)), 2.0f, 0, 1.2f * sc);
...
bool ModernAnimatedFolder(const char* label, bool* state) {
    ...
    float sc = g_autoScale * g_scale;
    FrostTheme& th = UITheme();
    ImU32 bg = hovered ? ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.12f))
                       : ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.05f));
    if (*state) bg = ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.20f));
    win->DrawList->AddRectFilled(bb.Min, bb.Max, bg, 2.0f * sc);
    win->DrawList->AddRect(bb.Min, bb.Max, *state ? ImGui::GetColorU32(ImVec4(th.primary.x, th.primary.y, th.primary.z, 0.85f)) : IM_COL32(255, 255, 255, 26), 2.0f * sc, 0, 1.0f);
...
void ModernTierSelector(const char* label, bool* tierArray) {
    ...
    for (int i = 1; i <= 5; i++) {
        ...
        win->DrawList->AddRectFilled(bb.Min, bb.Max, IM_COL32((int)(14+30*a), (int)(22+120*a), (int)(34+160*a), 255), 2.0f * g_autoScale);
        if (a > 0.01f) win->DrawList->AddRect(bb.Min, bb.Max, ImGui::GetColorU32(ImVec4(UITheme().primary.x, UITheme().primary.y, UITheme().primary.z, 0.9f * a)), 2.0f*g_autoScale, 0, 1.5f*g_autoScale);
        char buf[4]; snprintf(buf, sizeof(buf), "%d", i); ImVec2 t_sz = ImGui::CalcTextSize(buf);
        win->DrawList->AddText(pos + ImVec2((bb.GetWidth() - t_sz.x)*0.5f, (bb.GetHeight() - t_sz.y)*0.5f), tierArray[i] ? IM_COL32(6,10,18,255) : IM_COL32(210, 235, 245, 255), buf);
    }
}
...
void DrawMainMenu() {
    ...
    if (ImGui::Begin((const char*)u8"金铲铲助手 // CYBER STUDIO", &menu_visible, ImGuiWindowFlags_NoSavedSettings)) {
        ...
        if (!g_menuCollapsed) {
            ...
            case 6:
                {
                    DrawSectionTitle((const char*)u8"换肤 (棋盘 / 小小英雄)");
                    LoadSkinsFromFileOnce(); // 幂等: 启动时已加载过则跳过
                    if (ImGui::CollapsingHeader((const char*)u8"【棋盘换肤】", ImGuiTreeNodeFlags_DefaultOpen)) {
                    ...
                    if (ImGui::CollapsingHeader((const char*)u8"【小小英雄换肤】", ImGuiTreeNodeFlags_DefaultOpen)) {
                    ImGui::TextColored(ImVec4(0.3f, 0.9f, 1.0f, 1.0f), (const char*)u8"对局中加载小英雄时, 替换 x0(模型路径) 与 x1(展示模型名)");
                    ...
                    DrawGlassSeparator();
                    ImGui::TextColored(UITheme().primary, (const char*)u8"棋盘 Hook: %s", g_skin_hook_installed ? u8"已挂载 [OK]" : u8"未挂载 (启用时自动尝试)");
                    ImGui::TextColored(UITheme().primary, (const char*)u8"小英雄 Hook: %s", g_ll_hook_installed ? u8"已挂载 [OK]" : u8"未挂载 (启用时自动尝试)");
                    break;
                }
            default:
                current_tab = 0;
...
void* Il2CppInitThread(void*) {
    ...
    LoadConfig();
    LoadSkinsFromFileOnce(); // 启动即加载历史捕获的皮肤, 避免后续捕获时用空内存状态覆盖文件丢历史
    // 自动挂载核心 Hook
